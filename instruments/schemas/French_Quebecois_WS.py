...
class French_Quebecois_WS(BaseTable):
    ...
    item_665_choices = [('not yet', 'not yet'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_665 = models.CharField(max_length=9, choices=item_665_choices, null=True)
    item_666_choices = [('not yet', 'not yet'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_666 = models.CharField(max_length=9, choices=item_666_choices, null=True)
    item_667_choices = [('not yet', 'not yet'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_667 = models.CharField(max_length=9, choices=item_667_choices, null=True)
    item_668_choices = [('not yet', 'not yet'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_668 = models.CharField(max_length=9, choices=item_668_choices, null=True)
    item_669_choices = [('not yet', 'not yet'), ('sometimes', 'sometimes'), ('often', 'often')]
    ...
    item_705_choices = [('yes', 'yes'), ('no', 'no')]
