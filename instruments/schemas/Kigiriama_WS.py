...
class Kigiriama_WS(BaseTable):
    ...
    item_707_choices = [(u'not yet', u'not yet'), (u'sometimes', u'sometimes'), (u'often', u'often')]
    item_707 = models.CharField(max_length=9, choices=item_707_choices, null=True)
    item_708_choices = [(u'not yet', u'not yet'), (u'sometimes', u'sometimes'), (u'often', u'often')]
    item_708 = models.CharField(max_length=9, choices=item_708_choices, null=True)
    item_709_choices = [(u'not yet', u'not yet'), (u'sometimes', u'sometimes'), (u'often', u'often')]
    item_709 = models.CharField(max_length=9, choices=item_709_choices, null=True)
    item_710_choices = [(u'not yet', u'not yet'), (u'sometimes', u'sometimes'), (u'often', u'often')]
