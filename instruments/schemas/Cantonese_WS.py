...
class Cantonese_WS(BaseTable):
    ...
    item_810_choices = [('never', 'never'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_810 = models.CharField(max_length=9, choices=item_810_choices, null=True)
    item_811_choices = [('never', 'never'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_811 = models.CharField(max_length=9, choices=item_811_choices, null=True)
    item_812_choices = [('never', 'never'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_812 = models.CharField(max_length=9, choices=item_812_choices, null=True)
    item_813_choices = [('never', 'never'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_813 = models.CharField(max_length=9, choices=item_813_choices, null=True)
    item_814_choices = [('never', 'never'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_814 = models.CharField(max_length=9, choices=item_814_choices, null=True)
    item_815_choices = [('never', 'never'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_815 = models.CharField(max_length=9, choices=item_815_choices, null=True)
