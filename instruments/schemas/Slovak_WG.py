...
class Slovak_WG(BaseTable):
    ...
    item_33_choices = [('understands', 'understands')]
    item_33 = models.CharField(max_length=11, choices=item_33_choices, null=True)
    item_34_choices = [('understands', 'understands')]
