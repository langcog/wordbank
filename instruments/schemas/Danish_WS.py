...
class Danish_WS(BaseTable):
    ...
    item_726_choices = [('yes', 'yes'), ('no', 'no')]
    item_726 = models.CharField(max_length=3, choices=item_726_choices, null=True)
    item_727_choices = [('yes', 'yes'), ('no', 'no')]
    item_727 = models.CharField(max_length=3, choices=item_727_choices, null=True)
    item_728_choices = [('yes', 'yes'), ('no', 'no')]
    item_728 = models.CharField(max_length=3, choices=item_728_choices, null=True)
    item_729_choices = [('yes', 'yes'), ('no', 'no')]
    item_729 = models.CharField(max_length=3, choices=item_729_choices, null=True)
    item_730_choices = [('yes', 'yes'), ('no', 'no')]
    item_730 = models.CharField(max_length=3, choices=item_730_choices, null=True)
    item_731_choices = [('not yet', 'not yet'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_731 = models.CharField(max_length=9, choices=item_731_choices, null=True)
    ...
    item_734_choices = [('produces', 'produces')]
    item_734 = models.CharField(max_length=8, choices=item_734_choices, null=True)
    item_735_choices = [('produces', 'produces')]
    item_735 = models.CharField(max_length=8, choices=item_735_choices, null=True)
    item_736_choices = [('produces', 'produces')]
    item_736 = models.CharField(max_length=8, choices=item_736_choices, null=True)
    item_737_choices = [('produces', 'produces')]
    item_737 = models.CharField(max_length=8, choices=item_737_choices, null=True)
    item_738_choices = [('produces', 'produces')]
    item_738 = models.CharField(max_length=8, choices=item_738_choices, null=True)
    item_739_choices = [('produces', 'produces')]
    item_739 = models.CharField(max_length=8, choices=item_739_choices, null=True)
    item_740_choices = [('produces', 'produces')]
    item_740 = models.CharField(max_length=8, choices=item_740_choices, null=True)
    item_741_choices = [('produces', 'produces')]
    item_741 = models.CharField(max_length=8, choices=item_741_choices, null=True)
    item_742_choices = [('produces', 'produces')]
    item_742 = models.CharField(max_length=8, choices=item_742_choices, null=True)
    ...
    item_825_choices = [('not yet', 'not yet'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_825 = models.CharField(max_length=9, choices=item_825_choices, null=True)
    item_826_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_826 = models.CharField(max_length=7, choices=item_826_choices, null=True)
