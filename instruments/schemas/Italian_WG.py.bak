...
class Italian_WG(BaseTable):
    ...
    item_32_choices = [(u'not yet', u'not yet'), (u'sometimes', u'sometimes'), (u'often', u'often')]
    item_32 = models.CharField(max_length=9, choices=item_32_choices, null=True)
    item_33_choices = [(u'not yet', u'not yet'), (u'sometimes', u'sometimes'), (u'often', u'often')]
