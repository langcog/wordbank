...
class Italian_WG(BaseTable):
    ...
    item_32_choices = [('not yet', 'not yet'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_32 = models.CharField(max_length=9, choices=item_32_choices, null=True)
    item_33_choices = [('not yet', 'not yet'), ('sometimes', 'sometimes'), ('often', 'often')]
