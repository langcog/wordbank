...
class Spanish_Mexican_WS(BaseTable):
    ...
    item_681_choices = [('not yet', 'not yet'), ('sometimes/often', 'sometimes/often')]
    item_681 = models.CharField(max_length=16, choices=item_681_choices, null=True)
    item_682_choices = [('not yet', 'not yet'), ('sometimes/often', 'sometimes/often')]
    item_682 = models.CharField(max_length=16, choices=item_682_choices, null=True)
    item_683_choices = [('not yet', 'not yet'), ('sometimes/often', 'sometimes/often')]
    item_683 = models.CharField(max_length=16, choices=item_683_choices, null=True)
    item_684_choices = [('not yet', 'not yet'), ('sometimes/often', 'sometimes/often')]
    item_684 = models.CharField(max_length=16, choices=item_684_choices, null=True)
    item_685_choices = [('not yet', 'not yet'), ('sometimes/often', 'sometimes/often')]
    item_685 = models.CharField(max_length=16, choices=item_685_choices, null=True)
    ...
    item_710_choices = [('yes', 'yes'), ('no', 'no')]
    item_710 = models.CharField(max_length=3, choices=item_710_choices, null=True)
    ...
    item_738_choices = [('simple', 'simple'), ('complex', 'complex')]
