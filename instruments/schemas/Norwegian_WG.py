...
class Norwegian_WG(BaseTable):
    ...
    item_30_choices = [('never', 'never'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_30 = models.CharField(max_length=9, choices=item_30_choices, null=True)
    item_31_choices = [('never', 'never'), ('sometimes', 'sometimes'), ('often', 'often')]
    ...
    item_427_choices = [('not yet', 'not yet'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_427 = models.CharField(max_length=9, choices=item_427_choices, null=True)
    item_428_choices = [('not yet', 'not yet'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_428 = models.CharField(max_length=9, choices=item_428_choices, null=True)
    item_429_choices = [('not yet', 'not yet'), ('sometimes', 'sometimes'), ('often', 'often')]
