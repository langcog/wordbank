...
class English_American_WS(BaseTable):
    ...
    item_681_choices = [('not yet', 'not yet'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_681 = models.CharField(max_length=9, choices=item_681_choices, null=True)
    item_682_choices = [('not yet', 'not yet'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_682 = models.CharField(max_length=9, choices=item_682_choices, null=True)
    item_683_choices = [('not yet', 'not yet'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_683 = models.CharField(max_length=9, choices=item_683_choices, null=True)
    item_684_choices = [('not yet', 'not yet'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_684 = models.CharField(max_length=9, choices=item_684_choices, null=True)
    item_685_choices = [('not yet', 'not yet'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_685 = models.CharField(max_length=9, choices=item_685_choices, null=True)
    item_686_choices = [('not yet', 'not yet'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_686 = models.CharField(max_length=9, choices=item_686_choices, null=True)
    item_687_choices = [('not yet', 'not yet'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_687 = models.CharField(max_length=9, choices=item_687_choices, null=True)
    item_688_choices = [('not yet', 'not yet'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_688 = models.CharField(max_length=9, choices=item_688_choices, null=True)
    item_689_choices = [('not yet', 'not yet'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_689 = models.CharField(max_length=9, choices=item_689_choices, null=True)
    ...
    item_760_choices = [('not yet', 'not yet'), ('sometimes', 'sometimes'), ('often', 'often')]
    item_760 = models.CharField(max_length=9, choices=item_760_choices, null=True)
    item_761_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_761 = models.CharField(max_length=7, choices=item_761_choices, null=True)
    item_762_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_762 = models.CharField(max_length=7, choices=item_762_choices, null=True)
    item_763_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_763 = models.CharField(max_length=7, choices=item_763_choices, null=True)
    item_764_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_764 = models.CharField(max_length=7, choices=item_764_choices, null=True)
    item_765_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_765 = models.CharField(max_length=7, choices=item_765_choices, null=True)
    item_766_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_766 = models.CharField(max_length=7, choices=item_766_choices, null=True)
    item_767_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_767 = models.CharField(max_length=7, choices=item_767_choices, null=True)
    item_768_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_768 = models.CharField(max_length=7, choices=item_768_choices, null=True)
    item_769_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_769 = models.CharField(max_length=7, choices=item_769_choices, null=True)
    item_770_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_770 = models.CharField(max_length=7, choices=item_770_choices, null=True)
    item_771_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_771 = models.CharField(max_length=7, choices=item_771_choices, null=True)
    item_772_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_772 = models.CharField(max_length=7, choices=item_772_choices, null=True)
    item_773_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_773 = models.CharField(max_length=7, choices=item_773_choices, null=True)
    item_774_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_774 = models.CharField(max_length=7, choices=item_774_choices, null=True)
    item_775_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_775 = models.CharField(max_length=7, choices=item_775_choices, null=True)
    item_776_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_776 = models.CharField(max_length=7, choices=item_776_choices, null=True)
    item_777_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_777 = models.CharField(max_length=7, choices=item_777_choices, null=True)
    item_778_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_778 = models.CharField(max_length=7, choices=item_778_choices, null=True)
    item_779_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_779 = models.CharField(max_length=7, choices=item_779_choices, null=True)
    item_780_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_780 = models.CharField(max_length=7, choices=item_780_choices, null=True)
    item_781_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_781 = models.CharField(max_length=7, choices=item_781_choices, null=True)
    item_782_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_782 = models.CharField(max_length=7, choices=item_782_choices, null=True)
    item_783_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_783 = models.CharField(max_length=7, choices=item_783_choices, null=True)
    item_784_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_784 = models.CharField(max_length=7, choices=item_784_choices, null=True)
    item_785_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_785 = models.CharField(max_length=7, choices=item_785_choices, null=True)
    item_786_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_786 = models.CharField(max_length=7, choices=item_786_choices, null=True)
    item_787_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_787 = models.CharField(max_length=7, choices=item_787_choices, null=True)
    item_788_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_788 = models.CharField(max_length=7, choices=item_788_choices, null=True)
    item_789_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_789 = models.CharField(max_length=7, choices=item_789_choices, null=True)
    item_790_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_790 = models.CharField(max_length=7, choices=item_790_choices, null=True)
    item_791_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_791 = models.CharField(max_length=7, choices=item_791_choices, null=True)
    item_792_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_792 = models.CharField(max_length=7, choices=item_792_choices, null=True)
    item_793_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_793 = models.CharField(max_length=7, choices=item_793_choices, null=True)
    item_794_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_794 = models.CharField(max_length=7, choices=item_794_choices, null=True)
    item_795_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_795 = models.CharField(max_length=7, choices=item_795_choices, null=True)
    item_796_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_796 = models.CharField(max_length=7, choices=item_796_choices, null=True)
    item_797_choices = [('simple', 'simple'), ('complex', 'complex')]
    item_797 = models.CharField(max_length=7, choices=item_797_choices, null=True)
