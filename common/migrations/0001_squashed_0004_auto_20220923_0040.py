# Generated by Django 3.1.14 on 2023-11-29 13:03
...
class Migration(migrations.Migration):
    ...
    replaces = [('common', '0001_initial'), ('common', '0002_auto_20211126_0157'), ('common', '0003_child_race'), ('common', '0004_auto_20220923_0040')]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='DatasetOrigin',
            fields=[
                ('dataset_origin_name', models.CharField(max_length=251, primary_key=True, serialize=False)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exposure_proportion', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MaxValueValidator(100), django.core.validators.MinValueValidator(1)])),
                ('age_of_first_exposure', models.IntegerField(blank=True, null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(72)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('item_definition', models.CharField(blank=True, max_length=200, null=True)),
                ('study_internal_item', models.CharField(max_length=50)),
                ('english_gloss', models.CharField(blank=True, max_length=80, null=True)),
                ...
                ('item_category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='common.itemcategory')),
                ('uni_lemma', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='common.unilemma')),
            ],
        ),
        migrations.CreateModel(
            name='Dataset',
            fields=[
                ...
                ('dataset_origin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='common.datasetorigin')),
                ('instrument', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='common.instrument')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('study_internal_caregiver_education', models.CharField(blank=True, max_length=100, null=True)),
                ('date_of_birth', models.DateField(blank=True, null=True)),
                ('caregiver_education', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='common.caregivereducation')),
                ('dataset_origin', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='common.datasetorigin')),
                ('health_conditions', models.ManyToManyField(to='common.HealthCondition')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('production', models.IntegerField(null=True)),
                ('comprehension', models.IntegerField(null=True)),
                ('item_category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='common.itemcategory')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='administration',
            name='dataset',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='common.dataset'),
        ),
        migrations.AddField(
            model_name='administration',
            name='instrument',
