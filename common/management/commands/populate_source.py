...
class Command(NoArgsCommand):
    ...
    def handle(self, *args, **options):
        ...
        sources = [{'name': 'Marchman', 'dataset': 'Norming', 'instrument': 'English_WS', 'citation': 'Fenson 2007'},
                   ...
                   {'name': 'Byers', 'dataset': '', 'instrument': 'English_WS', 'citation': ''},
                   {'name': 'Marchman', 'dataset': 'Norming', 'instrument': 'English_WG', 'citation': ''},
                   {'name': 'Byers', 'dataset': '', 'instrument': 'English_WG', 'citation': ''},
                   {'name': 'Marchman', 'dataset': 'Norming', 'instrument': 'Spanish_WS', 'citation': ''},
                   {'name': 'Marchman', 'dataset': 'Norming', 'instrument': 'Spanish_WG', 'citation': ''},
