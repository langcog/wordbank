...
class Item(models.Model):
    ...
    item_category = models.ForeignKey(ItemCategory, null=True, on_delete=models.SET_NULL)
    instrument = models.ForeignKey(Instrument, on_delete=models.CASCADE)
    uni_lemma = models.ForeignKey(UniLemma, null=True, blank=True, on_delete=models.SET_NULL)
...
class Child(models.Model):
    ...
    dataset_origin = models.ForeignKey(DatasetOrigin, on_delete=models.CASCADE, null=True)
    
    study_internal_caregiver_education = models.CharField(max_length=100, null=True, blank=True)
    caregiver_education = models.ForeignKey(CaregiverEducation, null=True, blank=True, on_delete=models.SET_NULL)
...
class LanguageExposure(models.Model):
    ...
    exposure_proportion = models.IntegerField(blank=True, null=True,  #proportion of time on language for this administration
        validators=[
            MaxValueValidator(100),
            MinValueValidator(1)
        ] )
    age_of_first_exposure = models.IntegerField(blank=True, null=True,  #age in months of language acquisition
        validators=[
            MinValueValidator(0),
