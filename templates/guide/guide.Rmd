...
First, if you analyze specific datasets, please cite those datasets (see Contributors page). Then, as well as citing the particular sources for specific datasets you analyze, work using the Wordbank database should cite: Frank, M. C., Braginsky, M., Yurovsky, D., & Marchman, V. A. (in press). Wordbank: An open repository for developmental vocabulary data. *Journal of Child
Language*.
